...
ActiveRecord::Schema[7.0].define(version: 2023_04_15_140812) do
  ...
  create_table "reservations", force: :cascade do |t|
    ...
    t.index ["tutor_id", "date", "hour"], name: "index_reservations_on_tutor_id_and_date_and_hour", unique: true
  end
